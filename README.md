...
## Acknowledgments
While developing this extension, inspiration and guidance were also taken from [this repository](https://github.com/RVC-Boss/GPT-SoVITS), which has explored similar implementations.
