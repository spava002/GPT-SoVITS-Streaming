...
## How Can I Use It?
**Please ensure all requirements have been installed before proceeding.** Run inference.py to test TTS synthesis and make sure to replace checkpoint files with your own (if available, or you can find how to install the pretrained checkpoints at the original repository), and providing a reference audio.
